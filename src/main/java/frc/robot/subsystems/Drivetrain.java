...
public class Drivetrain {
  ...
  public Drivetrain() {
    ...
    m_odometry = new DifferentialDriveOdometry(new Rotation2d(m_gyro.getAngle()*(Math.PI/180)));
  }
  ...
  public void updateOdometry() {
    m_odometry.update(new Rotation2d(m_gyro.getAngle()*(Math.PI/180)), m_leftEncoder.getDistance(),
